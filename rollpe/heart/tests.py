...
class HeartCreateAPITest(APITestCase):
    ...
    def test_create_heart_without_authenticated(self):
        ...
        """
        response = self.client.post(self.heart_url, self.heart_data, format='json')
    ...
    def test_create_heart(self):
        ...
        # 응답 상태 코드 확인
        self.assertEqual(response.status_code, 201, '상태코드가 올바르지 않습니다.')
